...
import (
	...
	"github.com/nks5295/gokrb5/service"
...
cd $GOPATH/src/github.com/nks5295/gokrb5/testenv/krb5kdc-vagrant && vagrant up
cd $GOPATH/src/github.com/nks5295/gokrb5/testenv/krbhttp-vagrant && vagrant up
*/
func main() {
	s := httpServer()
	defer s.Close()
